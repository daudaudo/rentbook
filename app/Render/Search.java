...
public class Search implements Render {
    private View view;
    ...
    public void renderTitle(){
        ...
        searchText.setText("Kết quả tìm kiếm cho : "+req.input("search"));
    }
    ...
    public void renderTableBook() {
        ...
        ArrayList<HashMap<String, Object>> books =new Books().where("name like '%"+req.input("search")+"%'");
